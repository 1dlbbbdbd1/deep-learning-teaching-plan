...
当前完整课程已经写入到第 36 课。主线编号 00–36，加上第 01.5 课，一共 38 篇课程笔记。除第 01.5 课是过渡阅读课外，其余课程均配有可运行脚本；第 19–36 课覆盖 MLP、CNN、项目复刻、Debug 和最小 ViT。
...
- [第 36 课：最终复刻报告和 Debug 复盘](lessons/36-final-reproduction-report.md)
- [学习进度](progress.md)
